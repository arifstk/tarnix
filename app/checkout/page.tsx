...
//           <Link
//             href="/products"
//             className="px-5 py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-bold hover:bg-indigo-500"
//           >
//             Shop Now
//           </Link>
//         </div>
...
// app/checkout/page.tsx
// CHANGELOG: clientSecret fetched at page level and passed to Elements provider
