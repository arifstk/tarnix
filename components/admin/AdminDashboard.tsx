...
// const Card = ({ children, className = "" }: { children: React.ReactNode; className?: string }) => (
//   <div
//     className={`rounded-2xl p-5 bg-white border border-slate-200 shadow-sm ${className}`}
//   >
//     {children}
//   </div>
// );
...
//     <input
//       {...props}
//       className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-400/50 focus:border-indigo-400 transition-all duration-200"
//     />
//   </div>
// );
...
//   <button
//     onClick={onChange}
//     className={`relative inline-flex w-11 h-6 rounded-full transition-all duration-300 focus:outline-none shadow-inner ${checked ? "bg-indigo-500" : "bg-slate-200"}`}
//   >
...
//     ghost: "bg-white hover:bg-slate-50 text-slate-600 border border-slate-200 shadow-sm",
...
//     <button
//       onClick={onClick}
//       className={`${v} ${s} rounded-xl font-semibold transition-all duration-200 active:scale-95 ${className}`}
//     >
//       {children}
//     </button>
//   );
...
//         <button
//           onClick={onClose}
//           className="w-7 h-7 rounded-lg bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-500 hover:text-slate-700 transition-all"
//         >✕</button>
//       </div>
//       {children}
//     </div>
...
//       style={{ fontFamily: "'Plus Jakarta Sans','DM Sans',sans-serif", background: "#f1f5f9" }}
//     >
//       {/* ════ SIDEBAR ════ */}
//       <aside
//         className={`shrink-0 flex flex-col transition-all duration-300 ease-in-out ${sideOpen ? "w-56" : "w-16"}`}
//         style={{
...
//           <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center font-black text-sm text-white shrink-0 shadow-md shadow-indigo-200">
//             T
//           </div>
//           {sideOpen && (
//             <span className="font-black text-lg tracking-tight text-slate-800 whitespace-nowrap">
//               Tarnix
//             </span>
//           )}
//         </div>
...
//                 className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 cursor-pointer ${active
...
//             className="w-full flex items-center justify-center gap-2 py-2.5 border border-slate-200 rounded-xl text-slate-400 hover:text-slate-600 hover:bg-slate-50 transition-all duration-200 text-xs font-medium cursor-pointer"
//           >
//             <span className={`transition-transform duration-300 ${sideOpen ? "" : "rotate-180"}`}>◀</span>
//             {sideOpen && <span>Collapse</span>}
//           </button>
...
//         {/* Top bar */}
//         <header
//           className="h-16 flex items-center justify-between px-6 shrink-0 bg-white border-b border-slate-200"
//           style={{ boxShadow: "0 1px 8px rgba(0,0,0,0.05)" }}
//         >
//           <div>
//             <h1 className="text-base font-bold text-slate-800 capitalize">{section}</h1>
//             <p className="text-xs text-slate-400">Admin Panel · Tarnix</p>
//           </div>
//           <div className="flex items-center gap-3">
//             <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-xs font-bold text-white shadow-md shadow-indigo-200">
//               A
//             </div>
//             <span className="text-sm text-slate-700 font-semibold hidden sm:block">Admin</span>
//           </div>
//         </header>
...
//                   className="px-3.5 py-2 rounded-xl bg-white border border-slate-200 text-slate-700 text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-400/50 shadow-sm w-64"
//                 />
//               </div>
...
//                     <thead>
//                       <tr
//                         className="text-xs text-slate-500 uppercase tracking-wider border-b border-slate-100"
...
//                           <td className="px-5 py-3.5">
//                             <div className="flex items-center gap-2.5">
//                               <div className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-xs font-bold text-white shrink-0 shadow-sm">
//                                 {u.avatar}
//                               </div>
...
//                               className={`text-xs font-semibold px-2.5 py-1 rounded-full border-0 focus:outline-none focus:ring-2 focus:ring-indigo-400/50 cursor-pointer ${roleColors[u.role]} bg-transparent`}
//                             >
//                               <option value="user">user</option>
//                               <option value="admin">admin</option>
//                               <option value="deliveryBoy">deliveryBoy</option>
...
//                           </td>
//                           <td className="px-5 py-3.5 text-slate-400 text-xs">{u.joined}</td>
//                           <td className="px-5 py-3.5 text-slate-800 font-bold">{u.orders}</td>
//                           <td className="px-5 py-3.5">
//                             <div className="flex gap-1.5">
//                               <Btn variant="ghost" size="xs" onClick={() => setUserModal(u)}>Edit</Btn>
//                               <Btn variant="danger" size="xs" onClick={() => deleteUser(u.id)}>Delete</Btn>
...
//               {/* Save */}
//               <div className="flex justify-end">
//                 <Btn variant="primary" size="sm" onClick={handleSaveSettings}>
...
//               <select
//                 defaultValue={userModal.role}
//                 className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400/50"
//               >
//                 <option value="user">user</option>
//                 <option value="admin">admin</option>
//                 <option value="deliveryBoy">deliveryBoy</option>
...
//       {prodModal && (
//         <Modal
//           title={prodModal === "new" ? "Add New Product" : `Edit — ${(prodModal as Product).name}`}
//           onClose={() => setProdModal(null)}
//         >
//           <div className="space-y-3">
//             <Input
//               label="Product Name"
//               defaultValue={prodModal !== "new" ? (prodModal as Product).name : ""}
...
//                 label="Price ($)"
//                 type="number"
//                 defaultValue={prodModal !== "new" ? String((prodModal as Product).price) : ""}
//                 placeholder="0.00"
//               />
//               <Input
//                 label="Stock"
//                 type="number"
//                 defaultValue={prodModal !== "new" ? String((prodModal as Product).stock) : ""}
//                 placeholder="0"
//               />
//             </div>
//             <div>
//               <label className="block text-xs font-semibold text-slate-500 mb-1.5">Category</label>
//               <select className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400/50">
//                 {categories.map(c => <option key={c.id}>{c.name}</option>)}
//               </select>
//             </div>
//             <div>
...
//               <div className="w-full px-4 py-6 rounded-xl border-2 border-dashed border-slate-200 hover:border-indigo-400 text-center text-slate-400 text-xs cursor-pointer transition-colors hover:bg-indigo-50/50">
//                 📁 Click to upload or drag & drop
//               </div>
//             </div>
//             <div className="flex gap-3 pt-2">
//               <Btn variant="primary" className="flex-1" onClick={() => setProdModal(null)}>
//                 {prodModal === "new" ? "Add Product" : "Save Changes"}
//               </Btn>
//               <Btn variant="ghost" className="flex-1" onClick={() => setProdModal(null)}>Cancel</Btn>
//             </div>
//           </div>
...
//       {catModal && (
//         <Modal
//           title={catModal === "new" ? "Add New Category" : `Edit — ${(catModal as Category).name}`}
//           onClose={() => setCatModal(null)}
//         >
//           <div className="space-y-4">
//             <Input
//               label="Category Name"
//               defaultValue={catModal !== "new" ? (catModal as Category).name : ""}
//               placeholder="e.g. Electronics"
//             />
//             <Input
//               label="Slug"
//               defaultValue={catModal !== "new" ? (catModal as Category).slug : ""}
//               placeholder="e.g. electronics"
//             />
//             <div className="flex gap-3 pt-2">
//               <Btn variant="primary" className="flex-1" onClick={() => setCatModal(null)}>
//                 {catModal === "new" ? "Add Category" : "Save Changes"}
//               </Btn>
//               <Btn variant="ghost" className="flex-1" onClick={() => setCatModal(null)}>Cancel</Btn>
//             </div>
//           </div>
