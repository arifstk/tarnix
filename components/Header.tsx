...
//         {/* ── LEFT: Logo ── */}
//         <Link href={"/"}>
//           <h2 className="text-2xl text-tarnix_dark_green font-black tracking-wider hover:text-tarnix_light_green hoverEffect">
//             Tarnix
//           </h2>
//         </Link>
...
//                 key={link.href}
//                 href={link.href}
//                 className={`relative px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 group ${active
//                   ? "text-white"
...
//                 <span
//                   className={`absolute inset-0 rounded-lg transition-opacity duration-200 ${active
//                     ? "opacity-100 "
...
//                   <span className="absolute -top-1 -right-1 w-2 h-2 rounded-full bg-rose-500 ring-2 ring-[#0a0f1e] animate-pulse" />
//                 )}
//                 {/* Active underline */}
//                 {active && (
...
//                 className="flex items-center gap-2 pl-1 pr-3 py-1 rounded-xl bg-white/[0.06] border border-white/[0.08] hover:bg-white/[0.1] transition-all duration-200 group"
//               >
//                 {/* Avatar */}
//                 <div className="relative w-7 h-7 rounded-lg overflow-hidden ring-1 ring-indigo-500/60 shrink-0">
//                   {session.user?.image ? (
//                     <Image
//                       src={session.user.image}
...
//               {/* Dropdown menu */}
//               {dropdownOpen && (
//                 <div className="absolute right-0 mt-2 w-52 rounded-xl bg-[#111827] border border-white/[0.08] shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
//                   {/* User info */}
...
//             className="md:hidden flex items-center justify-center w-9 h-9 rounded-lg bg-white/[0.06] border border-white/[0.08] text-slate-300 hover:text-white hover:bg-white/[0.1] transition-all duration-200"
...
//       {/* ── Mobile nav drawer ── */}
//       {menuOpen && (
//         <div className="md:hidden border-t border-white/[0.06] bg-[#0a0f1e]/95 backdrop-blur-md">
    ...
    <header className="sticky top-0 z-50 backdrop-blur-md shadow-[0_1px_30px_rgba(0,0,0,0.4)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="shrink-0 flex items-center gap-2">
          ...
          {session ? (
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                ...
                {/* Name (hidden on small screens) */}
                <span className="hidden sm:block text-sm text-slate-200 font-medium max-w-25 truncate">
                  {session.user?.name?.split(" ")[0]}
                </span>
              ...
              {/* Dropdown menu */}
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-52 rounded-xl bg-[#111827] border border-white/8 shadow-2xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-150">
                  {/* User info */}
          ...
          <button
            onClick={() => setMenuOpen((v) => !v)}
            className="md:hidden flex items-center justify-center w-9 h-9 rounded-lg bg-white/6 border border-white/8 text-slate-300 hover:text-white hover:bg-white/10 transition-all duration-200"
            aria-label="Toggle menu"
          >
            {menuOpen ? (
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
