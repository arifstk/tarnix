...
// export default function CheckoutForm({ cart, subtotal }: Props) {
...
//   const total = subtotal; // extend with shipping/tax if needed

//   const handleChange = (e: React.ChangeEvent<HTMLInputElement>) =>
//     setForm((prev) => ({ ...prev, [e.target.name]: e.target.value }));

//   // When user switches to Stripe, create a PaymentIntent immediately
...
//         body: JSON.stringify({ amount: Math.round(total * 100) }), // cents
//       });
...
//               <input name="address" value={form.address} onChange={handleChange} placeholder="123 Main St, Apt 4B" className={inputClass} />
//             </div>
//             <div>
...
// components/CheckoutForm.tsx
// CHANGELOG: clientSecret now received as prop from page — no longer fetched here
